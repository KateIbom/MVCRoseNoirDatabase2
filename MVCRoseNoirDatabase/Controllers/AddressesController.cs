...
namespace MVCRoseNoirDatabase.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AddressId,AddressType,HouseNumber,Street,District,City,County,PostCode")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AddressId,AddressType,HouseNumber,Street,District,City,County,PostCode")] Address address)
        {
